      ...
      <nav className="bg-white py-4 px-6 flex items-center justify-between">
        <div className="flex items-center">
          <div className="flex items-center mr-10">
            ...
            <span className="ml-2 text-2xl font-bold">trydo</span>
          </div>
          <div className="hidden md:flex space-x-6">
            <a href="#" className="text-gray-500 hover:text-black">Home</a>
            <a href="#" className="text-gray-500 hover:text-black">Service</a>
            <a href="#" className="text-gray-500 hover:text-black">About</a>
            <a href="#" className="text-gray-500 hover:text-black">Pages</a>
            <a href="#" className="text-gray-500 hover:text-black">Blocks</a>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-center mb-4">Contact With Phone Number</h3>
              <div className="text-gray-600 text-center">
                <p className="mb-2">+057 254 365 456</p>
                <p>+856 325 652 984</p>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-center mb-4">Email Address</h3>
              <div className="text-gray-600 text-center">
                <p className="mb-2">admin@gmail.com</p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <div className="text-gray-600 text-center">
                <p className="mb-2">5678 Bangla Main Road, cities 580</p>
